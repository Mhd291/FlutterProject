...
import 'package:monfy_app/models/friend.dart';



class MyFreindsService{

  var url = Uri.parse(ServerConfig.DNS +ServerConfig.ShowMyFriends);


  Future<List<FriendElement>> GetUsers() async {
    print("I am here");
    ...
    {
      var UsersResponse = friendFromJson(response.body);
      print(response.statusCode);
      print(response.body);
      return UsersResponse.friends;
    }
    else return [];
  }
