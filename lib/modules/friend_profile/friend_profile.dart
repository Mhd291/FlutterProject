...
import 'friend_profile_controller.dart';

class FreindProfile extends StatelessWidget {
  static const double pImageHeightClosed = 400;
  double pIH = pImageHeightClosed;
  var id=Get.arguments;
  FriendProfileController controller1 = Get.put(FriendProfileController());
            ...
            children: <Widget>[
              ...
              Stack(
                children: [
                  ...
                  GetBuilder<FriendProfileController>(builder: (controller) {
                    return Positioned(
                      left: 30,
  ...
  SingleChildScrollView _panelBody(
    ...
    return SingleChildScrollView(
        ...
        child: GetBuilder<FriendProfileController>(
