...
class UserProfile extends StatelessWidget {
  ...
  UserProfileController controller1 = Get.put(UserProfileController());
                        ...
                        children: [
                          MaterialButton(
                            onPressed: () async{
                              ...
                              await controller1.SendFriendRequest();

                              if (controller1.SendRequestStatuse==true) {
                                EasyLoading.showSuccess('Request Send Successfully');
                                controller1.onClickUser();

                              }
                              else {
                                EasyLoading.showError('Request Not Send');
                                print("Error");
                              }
